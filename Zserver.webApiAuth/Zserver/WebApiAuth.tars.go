...
func (_obj *WebApiAuth) SysConfig_BatchDelete(id []int32, req *SysConfig, res *SysConfig, _opt ...map[string]string) (err error) {
...
func (_obj *WebApiAuth) SysConfig_BatchDeleteWithContext(tarsCtx context.Context, id []int32, req *SysConfig, res *SysConfig, _opt ...map[string]string) (err error) {
...
func (_obj *WebApiAuth) SysConfig_BatchDeleteOneWayWithContext(tarsCtx context.Context, id []int32, req *SysConfig, res *SysConfig, _opt ...map[string]string) (err error) {
...
type _impWebApiAuth interface {
	...
	SysConfig_BatchDelete(id []int32, req *SysConfig, res *SysConfig) (err error)
...
type _impWebApiAuthWithContext interface {
	...
	SysConfig_BatchDelete(tarsCtx context.Context, id []int32, req *SysConfig, res *SysConfig) (err error)
